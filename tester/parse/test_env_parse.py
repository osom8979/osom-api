...
class GetEnvNamespaceEnvironTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.original_module = exchange_env(self.RECCD_MODULE, self.module_value)
    ...
    def tearDown(self):
        exchange_env(self.RECCD_MODULE, self.original_module)
...
class GetFileEnvNamespaceEnvironTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.original_module = exchange_env(self.RECCD_MODULE_FILE, self.module_value)
    ...
    def tearDown(self):
        exchange_env(self.RECCD_MODULE_FILE, self.original_module)
        self.tmpdir.cleanup()
