...
SCHEME_DNS: Final[str] = "dns:"
SCHEME_UNIX: Final[str] = "unix:"
SCHEME_UNIX_ABSOLUTE: Final[str] = SCHEME_UNIX + "//"
SCHEME_UNIX_ABSTRACT: Final[str] = "unix-abstract:"
SCHEME_IPV4: Final[str] = "ipv4:"
SCHEME_IPV6: Final[str] = "ipv6:"

SCHEME_DNS_LEN: Final[int] = len(SCHEME_DNS)
SCHEME_UNIX_LEN: Final[int] = len(SCHEME_UNIX)
SCHEME_UNIX_ABSOLUTE_LEN: Final[int] = len(SCHEME_UNIX_ABSOLUTE)
SCHEME_UNIX_ABSTRACT_LEN: Final[int] = len(SCHEME_UNIX_ABSTRACT)
SCHEME_IPV4_LEN: Final[int] = len(SCHEME_IPV4)
SCHEME_IPV6_LEN: Final[int] = len(SCHEME_IPV6)
...
OPENING_AUTHORITY: Final[str] = "//"
OPENING_AUTHORITY_LEN: Final[int] = len(OPENING_AUTHORITY)

CLOSING_AUTHORITY: Final[str] = "/"
CLOSING_AUTHORITY_LEN: Final[int] = len(CLOSING_AUTHORITY)
